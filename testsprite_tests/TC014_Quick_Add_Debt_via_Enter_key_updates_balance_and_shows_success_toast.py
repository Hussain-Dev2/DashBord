...
async def run_test():
    ...
    try:
        ...
        # -> Click the red 'Add Debt' button on the first visible client row (Rapid Logistics).
        ...
        # -> Type '10' into the inline Add Debt amount input (index 635) and press Enter to submit.
        frame = context.pages[-1]
        # Input text
