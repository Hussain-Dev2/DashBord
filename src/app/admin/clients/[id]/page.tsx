          ...
          <div className="backdrop-blur-xl bg-gradient-to-br from-white/10 to-white/5 border border-white/20 rounded-2xl p-8 shadow-2xl h-full flex flex-col">
            ...
            <form 
              action={async (formData) => {
                ...
                if (content) await addNote(client.id, content)
              }} 
              className="relative"
            >
              <div className="relative">
                ...
                <button 
                  type="submit" 
                  className="absolute bottom-4 right-4 p-3 bg-gradient-to-r from-nexa-gold to-nexa-goldHover text-nexa-black rounded-lg hover:shadow-lg hover:shadow-nexa-gold/50 transition-all duration-300 hover:scale-105 active:scale-95"
                >
